                ...
                <div class="container-fluid">
                    <div class="collapse navbar-collapse" id="navbarText">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <!-- <li class="nav-item">
                              <button class=" btn btn-primary rounded "><a class="nav-link text-light" href="../php/registro_producto.php">Registrar Producto</a></button>
                            </li>
                            <li class="nav-item">
                            ...
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                <div class="perfil dropdown">
                                    ...
                                    <ul class="dropdown-menu " aria-labelledby="navbarDropdown">
                                        ...
                                        <li><a class="dropdown-item icon-perfil" href="../index.php"><i class="material-icons mr-2">highlight_off</i>Cerrar sesion</a></li>
                                    </ul>
                                </div>
                            </ul>
                        </span>
